...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    settings = ws_settings.Settings()   # dataset path settings
    ...
    if distill:
        ...
        expr_module = importlib.import_module('lib.train.train_script_hypertrack')
...
def main():
    ...
    parser.add_argument('--script', type=str, required=False, default="hypertrack_vis", help='Name of the train script.(hypertrack_vis,hypertrack_nir,hypertrack_rednir,imec25)')
    parser.add_argument('--config', type=str, required=False, default="baseline", help="Name of the config file.")
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local_rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir', type=str, default="/home/ubuntu/Downloads/hypertrack/models/result", help='the directory to save checkpoints and logs')
    parser.add_argument('--seed', type=int, default=42, help='seed for random numbers')
    parser.add_argument('--use_lmdb', type=int, choices=[0, 1], default=0)  # whether datasets are in lmdb format
    parser.add_argument('--script_prv', type=str, default="mixformer_vit_online", help='Name of the train script of previous model.')
    ...
    parser.add_argument('--stage1_model', type=str, default="/home/ubuntu/Downloads/hypertrack/models/hypertrackOnlineScore_ep0062.pth.tar")
