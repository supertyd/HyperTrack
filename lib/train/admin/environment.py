...
def create_default_local_file():
    ...
    default_settings = OrderedDict({
        ...
        "whisper_nir_false_dir": empty_str,
        "whisper_rednir_false_dir": empty_str,
        "whisper_vis_false_dir": empty_str
    })
...
def create_default_local_file_ITP_train(workspace_dir, data_dir):
    ...
    default_settings = OrderedDict({
        ...
        "whisper_dir": empty_str,
        "whisper_nir_dir": empty_str,
        "whisper_rednir_dir": empty_str,
        "whisper_vis_dir": empty_str
        })
