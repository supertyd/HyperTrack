...
cfg.TEST.UPDATE_INTERVALS.WHISPER_NIR = [200]
cfg.TEST.UPDATE_INTERVALS.UAV = [200]
cfg.TEST.UPDATE_INTERVALS.VOT20LT = [200]
cfg.TEST.UPDATE_INTERVALS.IMEC25 = [20]
...
cfg.TEST.ONLINE_SIZES.WHISPER_NIR = [2]
cfg.TEST.ONLINE_SIZES.UAV = [3]
cfg.TEST.ONLINE_SIZES.IMEC25 = [2]
