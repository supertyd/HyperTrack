...
dataset_dict = dict(
    whisper_nir=DatasetInfo(module=pt % "whisper", class_name="whisperDataset_nir", kwargs=dict()),
    whisper_rednir=DatasetInfo(module=pt % "whisper", class_name="whisperDataset_rednir", kwargs=dict()),
    whisper_vis=DatasetInfo(module=pt % "whisper", class_name="whisperDataset_vis", kwargs=dict()),
    imec25 = DatasetInfo(module=pt % "imec25", class_name="imec25Dataset", kwargs=dict()),
