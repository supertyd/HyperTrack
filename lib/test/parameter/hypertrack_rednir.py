...
from lib.config.hypertrack_rednir.config import cfg, update_config_from_file
...
def parameters(yaml_name: str, model=None, search_area_scale=None):
    ...
    yaml_file = os.path.join(prj_dir, 'experiments/hypertrack_rednir/%s.yaml' % yaml_name)
